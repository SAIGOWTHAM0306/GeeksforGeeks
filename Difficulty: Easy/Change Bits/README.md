<h2><a href="https://www.geeksforgeeks.org/problems/change-bits1538/1?page=2&category=Bit%20Magic&difficulty=Basic,Easy&sortBy=submissions">Change Bits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N,</strong>&nbsp;complete the following&nbsp;tasks,<br>
